...
public class Target {
    ...
    private final Point basketBottomLeft;
    private final RectF successfulPoint;
    private final RectF board;
    private final RectF ringBounce;
    ...
    public Target(int screenX, int screenY){
        ...
        basketBottomLeft.y=(int)((float) screenY /5)*4;
